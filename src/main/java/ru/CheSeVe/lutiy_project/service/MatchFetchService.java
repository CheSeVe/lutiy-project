...
public class MatchFetchService {
    ...
    public static final Logger log = LoggerFactory.getLogger(MatchFetchService.class);
    ...
    public MatchFetchService(MatchRepository matchRepository, StratzApiService stratzApiService, MatchIdRepository matchIdRepository, MatchMapper mapper) {
